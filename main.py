...
def extract_data(invoicefile, templates=None, input_module=pdftotext):
    ...
    for t in templates:
        ...
        if t.matches_input(optimized_str):
            if t.options['input_module']!="pdftotext":
                input_module=t.options['input_module']
                extracted_str = input_mapping[input_module].to_text(invoicefile)
                optimized_str = t.prepare_input(extracted_str)
